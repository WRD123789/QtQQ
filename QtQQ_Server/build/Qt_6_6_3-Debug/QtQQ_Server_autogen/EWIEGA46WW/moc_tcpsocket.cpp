...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTcpSocketENDCLASS_t qt_meta_stringdata_CLASSTcpSocketENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 23),  // "signalGetDataFromClient"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 11),  // "QByteArray&"
        QT_MOC_LITERAL(47, 24),  // "signalClientDisconnected"
        QT_MOC_LITERAL(72, 13),  // "onReceiveData"
        QT_MOC_LITERAL(86, 20)   // "onClientDisconnected"
    },
    "TcpSocket",
    "signalGetDataFromClient",
    "",
...
Q_CONSTINIT const QMetaObject TcpSocket::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTcpSocketENDCLASS_t,
        ...
        // method 'signalGetDataFromClient'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<QByteArray &, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
        // method 'signalClientDisconnected'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<int, std::false_type>,
...
void TcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalGetDataFromClient((*reinterpret_cast< std::add_pointer_t<QByteArray&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 1: _t->signalClientDisconnected((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->onReceiveData(); break;
        ...
        {
            using _t = void (TcpSocket::*)(QByteArray & , int );
            if (_t _q_method = &TcpSocket::signalGetDataFromClient; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &TcpSocket::signalClientDisconnected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void TcpSocket::signalGetDataFromClient(QByteArray & _t1, int _t2)
{
...
// SIGNAL 1
void TcpSocket::signalClientDisconnected(int _t1)
{

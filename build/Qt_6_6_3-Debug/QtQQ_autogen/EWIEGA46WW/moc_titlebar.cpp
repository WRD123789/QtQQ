...
constexpr auto qt_meta_stringdata_CLASSTitleBarENDCLASS = QtMocHelpers::stringData(
    "TitleBar",
    "signalButtonMinClicked",
    "",
    "signalButtonRestoreClicked",
    "signalButtonMaxClicked",
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTitleBarENDCLASS_t qt_meta_stringdata_CLASSTitleBarENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 22),  // "signalButtonMinClicked"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 26),  // "signalButtonRestoreClicked"
        QT_MOC_LITERAL(60, 22),  // "signalButtonMaxClicked"
        QT_MOC_LITERAL(83, 24),  // "signalButtonCloseClicked"
        QT_MOC_LITERAL(108, 18),  // "onButtonMinClicked"
        QT_MOC_LITERAL(127, 22),  // "onButtonRestoreClicked"
        QT_MOC_LITERAL(150, 18),  // "onButtonMaxClicked"
        QT_MOC_LITERAL(169, 20)   // "onButtonCloseClicked"
    },
    "TitleBar",
    "signalButtonMinClicked",
    "",
...
Q_CONSTINIT const QMetaObject TitleBar::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTitleBarENDCLASS_t,
        ...
        // method 'signalButtonMinClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signalButtonRestoreClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signalButtonMaxClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signalButtonCloseClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void TitleBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &TitleBar::signalButtonMinClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (_t _q_method = &TitleBar::signalButtonRestoreClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (_t _q_method = &TitleBar::signalButtonMaxClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TitleBar::*)();
            if (_t _q_method = &TitleBar::signalButtonCloseClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }

...
struct qt_meta_stringdata_CLASSSysTrayENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSysTrayENDCLASS = QtMocHelpers::stringData(
    "SysTray",
    "onIconActivated",
    "",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSSysTrayENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSSysTrayENDCLASS_t qt_meta_stringdata_CLASSSysTrayENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "SysTray"
        QT_MOC_LITERAL(8, 15),  // "onIconActivated"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 33),  // "QSystemTrayIcon::ActivationRe..."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSysTrayENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SysTray::staticMetaObject = { {
    QMetaObject::SuperData::link<QSystemTrayIcon::staticMetaObject>(),
    qt_meta_stringdata_CLASSSysTrayENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSysTrayENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSysTrayENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SysTray::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSysTrayENDCLASS.stringdata0))

...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMsgWebViewENDCLASS_t qt_meta_stringdata_CLASSMsgWebViewENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 13),  // "signalSendMsg"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 8),  // "QString&"
        QT_MOC_LITERAL(35, 3),  // "msg"
        QT_MOC_LITERAL(39, 4),  // "int&"
        QT_MOC_LITERAL(44, 7),  // "msgType"
        QT_MOC_LITERAL(52, 4)   // "file"
    },
    "MsgWebView",
    "signalSendMsg",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMsgWebViewENDCLASS[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       1,    2,   33,    2, 0x26,    5 /* Public | MethodCloned */,
...
void MsgWebView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalSendMsg((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int&>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
        case 1: _t->signalSendMsg((*reinterpret_cast< std::add_pointer_t<QString&>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int&>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MsgWebView::signalSendMsg; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }

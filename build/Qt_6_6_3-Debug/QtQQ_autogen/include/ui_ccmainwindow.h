...
public:
    ...
    void setupUi(QWidget *CCMainWindow)
    {
        if (CCMainWindow->objectName().isEmpty())
            CCMainWindow->setObjectName("CCMainWindow");
        CCMainWindow->resize(280, 680);
        CCMainWindow->setMinimumSize(QSize(280, 680));
        verticalLayout_6 = new QVBoxLayout(CCMainWindow);
        verticalLayout_6->setSpacing(0);
        verticalLayout_6->setObjectName("verticalLayout_6");
        verticalLayout_6->setContentsMargins(0, 0, 0, 0);
        titleWidget = new QWidget(CCMainWindow);
...
"font:75 \"PingFang SC\";"));
        ...
        widget = new QWidget(CCMainWindow);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 278, 458));
        ...
        bottomWidget = new QWidget(CCMainWindow);
        ...
        retranslateUi(CCMainWindow);

        QMetaObject::connectSlotsByName(CCMainWindow);
    } // setupUi

    void retranslateUi(QWidget *CCMainWindow)
    {
        CCMainWindow->setWindowTitle(QCoreApplication::translate("CCMainWindow", "CCMainWindow", nullptr));
        ...
        nameLabel->setText(QCoreApplication::translate("CCMainWindow", "\346\265\213\350\257\225\350\264\246\345\217\267", nullptr));
        statusBtn->setText(QString());
        levelBtn->setText(QString());
        lineEdit->setPlaceholderText(QCoreApplication::translate("CCMainWindow", "\344\270\252\346\200\247\347\255\276\345\220\215", nullptr));
        searchLineEdit->setPlaceholderText(QCoreApplication::translate("CCMainWindow", "\346\220\234\347\264\242\350\201\224\347\263\273\344\272\272\343\200\201\347\276\244\350\201\212", nullptr));
        ...
        bottomBtn_7->setText(QCoreApplication::translate("CCMainWindow", "\345\272\224\347\224\250\345\256\235", nullptr));
    } // retranslateUi

};

namespace Ui {
    class CCMainWindow: public Ui_CCMainWindow {};
} // namespace Ui

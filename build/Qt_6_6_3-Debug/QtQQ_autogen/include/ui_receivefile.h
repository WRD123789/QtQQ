...
public:
    ...
    void setupUi(QWidget *ReceiveFile)
    {
        ...
        label->setGeometry(QRect(30, 20, 411, 21));
        okBtn = new QPushButton(bodyWidget);
        okBtn->setObjectName("okBtn");
        okBtn->setGeometry(QRect(270, 70, 100, 32));
        cancelBtn = new QPushButton(bodyWidget);
        cancelBtn->setObjectName("cancelBtn");
        cancelBtn->setGeometry(QRect(390, 70, 100, 32));
    ...
    void retranslateUi(QWidget *ReceiveFile)
    {
        ...
        label->setText(QCoreApplication::translate("ReceiveFile", "\346\235\245\350\207\252 xxx \347\232\204\346\226\207\344\273\266: \346\230\257\345\220\246\346\216\245\346\224\266?", nullptr));

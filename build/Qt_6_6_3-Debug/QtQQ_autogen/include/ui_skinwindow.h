...
public:
    ...
    void setupUi(QWidget *SkinWindow)
    {
        if (SkinWindow->objectName().isEmpty())
            SkinWindow->setObjectName("SkinWindow");
        ...
        horizontalLayout->setContentsMargins(-1, 0, 4, 0);
        ...
        horizontalSpacer = new QSpacerItem(295, 9, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
